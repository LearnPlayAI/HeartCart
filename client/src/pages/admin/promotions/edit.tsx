...
interface Promotion {
  ...
  endDate: string;
  isActive: boolean;
  promotionType: 'percentage' | 'fixed' | 'bogo' | 'minimum_quantity_same_promotion' | 'minimum_order_value' | 'buy_x_get_y' | 'category_mix';
...
// Helper function to determine the display promotion type
const getDisplayPromotionType = (promotion: any) => {
