    ...
    try {
      ...
      if (centralizedAttrs && centralizedAttrs.length > 0) {
        ...
        return centralizedAttrs.map(attr => ({
          ...
          attributeOptionId: Array.isArray(attr.selectedOptions) && attr.selectedOptions.length > 0 
      ...
      switch(step) {
        ...
        case 5: // Handle numeric equivalent
          ...
          updateData = {
            ...
            discountLabel: draftData.onSale === false ? null : 
                          (draftData.discountLabel !== undefined ? draftData.discountLabel : existingDraft.discountLabel),
