import { 
  ...
  userFavourites, type UserFavourite, type InsertUserFavourite,
  productInteractions, type ProductInteraction, type InsertProductInteraction,
...
export interface IStorage {
  ...
  getAbandonedCarts(options?: { emailSent?: boolean; limit?: number }): Promise<AbandonedCart[]>;
  updateAbandonedCart(id: number, updates: Partial<AbandonedCart>): Promise<AbandonedCart | undefined>;
  markCartAsRecovered(id: number): Promise<boolean>;
}
